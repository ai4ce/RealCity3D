...
from pospred_model import MAGECityGenPospred
...
def get_args_parser():
    ...
    # Dataset parameters
    parser.add_argument('--data_path', default='../../datasets/boxstates/states_d50.npy', type=str,
                        help='dataset path')

    parser.add_argument('--output_dir', default='../../results/train/box/pos/output_dir_pospred',
                        help='path where to save, empty for no saving')
    parser.add_argument('--log_dir', default='../../results/train/box/pos/output_log_pospred',
...
def main(args):
    ...
    model = MAGECityGenPospred(drop_ratio = args.drop_ratio, 
    ...
    for epoch in range(args.start_epoch, args.epochs):
        ...
        print('train_loss_bce:', loss.item()) 
        ...
        for valid_step, valid_samples in enumerate(data_loader_valid):
            ...
            with torch.no_grad():
                ...
                loss, _, _  = model(valid_samples, mask_ratio=args.mask_ratio)  
        ...
        print('epoch:', epoch, 'val_loss_bce: ', loss.item())
