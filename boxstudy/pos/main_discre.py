...
def get_args_parser():
    ...
    parser.add_argument('--output_dir', default='../../results/train/box/pos/output_dir_pos',
                        help='path where to save, empty for no saving')
    parser.add_argument('--log_dir', default='../../results/train/box/pos/output_log_pos',
...
def main(args):
    ...
    model = MAGECityGen(drop_ratio = args.drop_ratio, 
    ...
    for epoch in range(args.start_epoch, args.epochs):
        ...
        for data_iter_step, samples in enumerate(data_loader_train):
            ...
            loss, _, _, loss_giou, loss_l1  = model(samples, mask_ratio=args.mask_ratio)
        ...
        for valid_step, valid_samples in enumerate(data_loader_valid):
            ...
            with torch.no_grad():
                ...
                loss, _, _, loss_giou, loss_l1  = model(valid_samples, mask_ratio=args.mask_ratio)  
