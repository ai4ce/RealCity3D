...
def cal_giou(box1:torch.Tensor, box2:torch.Tensor, enclosing_type:str="smallest"):
    ...
    # print('( area_c - u )/(area_c+1e-8): ',( area_c - u )/(area_c+1e-8))
...
if __name__ == "__main__":
    ...
    # giou_loss, iou = cal_giou(tensor1, tensor1)
    # print(giou_loss)
    # print(iou)
    test1 = torch.tensor([[[[0.5,0.5],[0.5,0.6],[0.6,0.5],[0.6,0.6]]]])
    test2 = torch.tensor([[[[0.5,0.5],[0.5,0.6],[0.6,0.5],[0.6,0.6]]]])
    print(enclosing_box(test1, test2, 'smallest'))