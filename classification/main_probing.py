...
from linear_probing import MAGECityPolyGenProb
...
def main(args):
    ...
    # define the model
    model = MAGECityPolyGenProb(device = args.device)
    
    pretrained_model = torch.load('./mae_classification_pretrained.pth')
