...
def get_args_parser():
    ...
    parser.add_argument('--draw_dir', default='../results/test/statepoly_draw_auto_noise/',
                        help='path where to save, empty for no saving')
    parser.add_argument('--model_path', default='/home/rl4citygen/InfiniteCityGen/results/train/polyautonoise/output_dir/64_800_12_8_8_512_512_0.1/mae_reconstruction_best.pth')
...
def main(args):
    ...
    for epoch in range(args.epochs):
        for valid_step, (samples, pos, info) in enumerate(data_loader_valid):
            ...
            line = np.zeros((500, 10, 3), np.uint8)
