...
def get_args_parser():
    ...
    parser.add_argument('--quant', type = int, default=100)
...
def main(args):
    ...
    dataset_train = PolyDataset(args.data_path, args.datapos_path, args.datainfo_path, train=True,split_ratio = args.split_ratio)
    ...
    # define the model
    model = MAGECityPolyGen(drop_ratio = args.drop_ratio, num_heads=args.num_heads, device = args.device, quant = args.quant,
